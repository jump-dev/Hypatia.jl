...
cone_from_moi(s::WSOSPolyInterpCone) = CO.WSOSPolyInterp(s.dimension, s.ipwt, s.isdual)
cone_from_moi(s::WSOSPolyInterpMatCone) = CO.WSOSPolyInterpMat(s.r, s.u, s.ipwt, s.isdual)
