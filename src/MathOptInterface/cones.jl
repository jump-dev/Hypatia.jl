...
function EpiNormSpectralCone{T, R}(n::Int, m::Int) where {T <: Real, R <: RealOrComplex{T}}
    return EpiNormSpectralCone{T, R}(n, m, false)
end

function MOI.dimension(
    cone::EpiNormSpectralCone{T, R},
) where {T <: Real, R <: RealOrComplex{T}}
    return 1 + Cones.vec_length(R, cone.n * cone.m)
end
...
function cone_from_moi(
    ...
    return Cones.EpiNormSpectral{T, R}(cone.n, cone.m, use_dual = cone.use_dual)
end
...
function MatrixEpiPerSquareCone{T, R}(
    ...
    return MatrixEpiPerSquareCone{T, R}(n, m, false)
end

function MOI.dimension(
    cone::MatrixEpiPerSquareCone{T, R},
) where {T <: Real, R <: RealOrComplex{T}}
    return Cones.svec_length(R, cone.n) + 1 + Cones.vec_length(R, cone.n * cone.m)
end
...
function cone_from_moi(
    ...
    return Cones.MatrixEpiPerSquare{T, R}(cone.n, cone.m, use_dual = cone.use_dual)
end
