...
cone_from_moi(s::MOI.PositiveSemidefiniteConeTriangle) = Cones.PosSemidef{Float64, Float64}(MOI.dimension(s))
cone_from_moi(s::MOI.LogDetConeTriangle) = Cones.HypoPerLogdet{Float64}(MOI.dimension(s))
