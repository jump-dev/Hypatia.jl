    ...
    for k in eachindex(cone.Ps)
        ...
        for p in 1:U
            ...
            for q in 1:U, r in 1:U
                ...
                # @show isapprox(PlambdaPk_slice_pr, PlambdaPk_slice_rp')
            ...
            tmp_vec = smat_to_svec!(similar(corr, r_dim), tmp, cone.rt2)
            corr_shuf[block_idxs(r_dim, p)] += tmp_vec
        end
    end
