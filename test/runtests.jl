...
@testset "native tests: $t, $s, $m, $n, $T, $tf" for t in testfuns_raw, s in system_solvers, m in linear_models, n in use_infty_nbhd, T in real_types, tf in [true, false]
    ...
    test_options = (
        ...
        system_solver_options = (use_iterative = tf,),
