...
#     namedpoly11,
#     ]
# @testset "native examples: $t, $s" for t in testfuns, s in system_solvers
#     t(verbose, s)
# end
...
# # @testset "MOI tests: $l, $(d ? "dense" : "sparse")" for l in system_solvers, d in (false, true)
#     test_moi(verbose = verbose, use_dense = d)
#     # test_moi(verbose = verbose, system_solver = l, use_dense = d)
# end
#
