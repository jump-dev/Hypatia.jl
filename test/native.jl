...
function solveandcheck(model::MO.LinearModel, solver::SO.Solver; atol = 1e-4, rtol = 1e-4)
    SO.solve(solver)
...
function dimension1(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    c = Float64[-1, 0]
...
function orthant1(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    ...
    # nonnegative cone
    model = linear_model(c, A, b, SparseMatrixCSC(-1.0I, q, n), h, [CO.Nonnegative(q)], [1:q])
    ...
    # nonpositive cone
    model = linear_model(c, A, b, SparseMatrixCSC(1.0I, q, n), h, [CO.Nonpositive(q)], [1:q])
...
function orthant2(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    Random.seed!(1)
    (n, p, q) = (5, 2, 10)
    c = rand(0.0:9.0, n)
    A = rand(-9.0:9.0, p, n)
    ...
    # use dual barrier
    model = linear_model(c, A, b, G, h, [CO.Nonnegative(q, true)], [1:q])
    ...
    # use primal barrier
    model = linear_model(c, A, b, G, h, [CO.Nonnegative(q, false)], [1:q])
...
function orthant3(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    Random.seed!(1)
    (n, p, q) = (15, 6, 15)
    c = rand(0.0:9.0, n)
    A = rand(-9.0:9.0, p, n)
    ...
    # use dual barrier
    model = linear_model(c, A, b, G, h, [CO.Nonpositive(q, true)], [1:q])
    r1 = solveandcheck(model, SO.HSDSolver(model, verbose = verbose, stepper = SO.CombinedHSDStepper(model, system_solver = system_solver(model))))
    @test r1.status == :Optimal

    # use primal barrier
    model = linear_model(c, A, b, G, h, [CO.Nonpositive(q, false)], [1:q])
    r2 = solveandcheck(model, SO.HSDSolver(model, verbose = verbose, stepper = SO.CombinedHSDStepper(model, system_solver = system_solver(model))))
    @test r2.status == :Optimal
...
function orthant4(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    Random.seed!(1)
    (n, p, q) = (5, 2, 10)
    c = rand(0.0:9.0, n)
    A = rand(-9.0:9.0, p, n)
    ...
    model = linear_model(c, A, b, G, h, [CO.Nonnegative(4, false), CO.Nonnegative(6, true)], [1:4, 5:10])
    r1 = solveandcheck(model, SO.HSDSolver(model, verbose = verbose, stepper = SO.CombinedHSDStepper(model, system_solver = system_solver(model))))
    @test r1.status == :Optimal

    # only nonnegative cone
    model = linear_model(c, A, b, G, h, [CO.Nonnegative(10, false)], [1:10])
    r2 = solveandcheck(model, SO.HSDSolver(model, verbose = verbose, stepper = SO.CombinedHSDStepper(model, system_solver = system_solver(model))))
    @test r2.status == :Optimal
...
function epinorminf1(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    c = Float64[0, -1, -1]
...
function epinorminf2(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    Random.seed!(1)
...
function epinorminf4(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    c = Float64[0, 1, -1]
    A = Float64[1 0 0; 0 1 0]
    b = Float64[1, -0.4]
    G = SparseMatrixCSC(-1.0I, 3, 3)
...
function epinorminf5(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    Random.seed!(1)
    c = Float64[1, 0, 0, 0, 0, 0]
    A = rand(-9.0:9.0, 3, 6)
    b = A * ones(6)
...
function epinormeucl1(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    c = Float64[0, -1, -1]
    A = Float64[1 0 0; 0 1 0]
    b = Float64[1, inv(sqrt(2))]
    G = SparseMatrixCSC(-1.0I, 3, 3)
    ...
    for is_dual in (true, false)
        model = linear_model(c, A, b, G, h, [CO.EpiNormEucl(3, is_dual)], [1:3])
        solver = SO.HSDSolver(model, verbose = verbose, stepper = SO.CombinedHSDStepper(model, system_solver = system_solver(model)))
        r = solveandcheck(model, solver)
        @test r.status == :Optimal
...
function epinormeucl2(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    c = Float64[0, -1, -1]
    A = Float64[1 0 0]
    b = Float64[0]
    G = SparseMatrixCSC(-1.0I, 3, 3)
...
function epipersquare1(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    c = Float64[0, 0, -1, -1]
    ...
    for is_dual in (true, false)
        model = linear_model(c, A, b, G, h, [CO.EpiPerSquare(4, is_dual)], [1:4])
        solver = SO.HSDSolver(model, verbose = verbose, stepper = SO.CombinedHSDStepper(model, system_solver = system_solver(model)))
        r = solveandcheck(model, solver)
        @test r.status == :Optimal
        @test r.primal_obj ≈ -sqrt(2) atol = 1e-4 rtol = 1e-4
...
function epipersquare2(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    c = Float64[0, 0, -1]
    A = Float64[1 0 0; 0 1 0]
    ...
    for is_dual in (true, false)
        model = linear_model(c, A, b, G, h, [CO.EpiPerSquare(3, is_dual)], [1:3])
        solver = SO.HSDSolver(model, verbose = verbose, stepper = SO.CombinedHSDStepper(model, system_solver = system_solver(model)))
        r = solveandcheck(model, solver)
        @test r.status == :Optimal
...
function epipersquare3(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    c = Float64[0, 1, -1, -1]
    A = Float64[1 0 0 0]
    b = Float64[0]
    G = SparseMatrixCSC(-1.0I, 4, 4)
...
function semidefinite1(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    c = Float64[0, -1, 0]
    ...
    for is_dual in (true, false)
        model = linear_model(c, A, b, G, h, [CO.PosSemidef(3, is_dual)], [1:3])
        solver = SO.HSDSolver(model, verbose = verbose, stepper = SO.CombinedHSDStepper(model, system_solver = system_solver(model)))
        r = solveandcheck(model, solver)
        @test r.status == :Optimal
        @test r.primal_obj ≈ -1 atol = 1e-4 rtol = 1e-4
...
function semidefinite2(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    c = Float64[0, -1, 0]
    A = Float64[1 0 1]
    b = Float64[0]
    G = SparseMatrixCSC(-1.0I, 3, 3)
...
function semidefinite3(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    ...
    for is_dual in (true, false)
        model = linear_model(c, A, b, G, h, [CO.PosSemidef(6, is_dual)], [1:6])
        solver = SO.HSDSolver(model, verbose = verbose, stepper = SO.CombinedHSDStepper(model, system_solver = system_solver(model)))
        r = solveandcheck(model, solver)
        @test r.status == :Optimal
...
function hypoperlog1(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    c = Float64[1, 1, 1]
...
function hypoperlog2(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    c = Float64[-1, 0, 0]
    A = Float64[0 1 0]
    b = Float64[0]
    G = SparseMatrixCSC(-1.0I, 3, 3)
...
function hypoperlog3(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    c = Float64[1, 1, 1]
...
function hypoperlog4(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    c = Float64[0, 0, 1]
    A = Float64[0 1 0; 1 0 0]
    b = Float64[1, -1]
    G = SparseMatrixCSC(-1.0I, 3, 3)
...
function epiperpower1(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    c = Float64[1, 0, -1, 0, 0, -1]
...
function epiperpower2(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    c = Float64[0, 0, -1]
    A = Float64[1 0 0; 0 1 0]
    b = Float64[1/2, 1]
    G = SparseMatrixCSC(-1.0I, 3, 3)
    ...
    for is_dual in (true, false)
        model = linear_model(c, A, b, G, h, [CO.EpiPerPower(2.0, is_dual)], [1:3])
        solver = SO.HSDSolver(model, verbose = verbose, stepper = SO.CombinedHSDStepper(model, system_solver = system_solver(model)))
        r = solveandcheck(model, solver)
        @test r.status == :Optimal
...
function epiperpower3(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    c = Float64[0, 0, 1]
    A = Float64[1 0 0; 0 1 0]
    b = Float64[0, 1]
    G = SparseMatrixCSC(-1.0I, 3, 3)
...
function hypogeomean1(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
...
function hypogeomean2(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    c = Float64[-1, 0, 0]
    ...
    for is_dual in (true, false)
        model = linear_model(c, A, b, G, h, [CO.HypoGeomean([0.5, 0.5], is_dual)], [1:3])
        solver = SO.HSDSolver(model, verbose = verbose, stepper = SO.CombinedHSDStepper(model, system_solver = system_solver(model)))
        r = solveandcheck(model, solver)
        @test r.status == :Optimal
...
function hypogeomean3(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    l = 4
    c = vcat(0.0, ones(l))
    ...
    for is_dual in (true, false)
        b = (is_dual ? [-1.0] : [1.0])
        model = linear_model(c, A, b, G, h, [CO.HypoGeomean(fill(inv(l), l), is_dual)], [1:(l + 1)])
        solver = SO.HSDSolver(model, verbose = verbose, stepper = SO.CombinedHSDStepper(model, system_solver = system_solver(model)))
        r = solveandcheck(model, solver)
        @test r.status == :Optimal
...
function hypogeomean4(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    l = 4
    c = ones(l)
    A = zeros(0, l)
    b = zeros(0)
...
function epinormspectral1(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    Random.seed!(1)
    (Xn, Xm) = (3, 4)
    Xnm = Xn * Xm
    ...
    for is_dual in (true, false)
        model = linear_model(c, A, b, G, h, [CO.EpiNormSpectral(Xn, Xm, is_dual)], [1:(Xnm + 1)])
        solver = SO.HSDSolver(model, verbose = verbose, stepper = SO.CombinedHSDStepper(model, system_solver = system_solver(model)))
        r = solveandcheck(model, solver)
        @test r.status == :Optimal
        if is_dual
...
function hypoperlogdet1(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    Random.seed!(1)
    side = 4
...
function hypoperlogdet2(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    Random.seed!(1)
    side = 3
    dim = 2 + div(side * (side + 1), 2)
    c = Float64[0, 1]
...
function hypoperlogdet3(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    Random.seed!(1)
    side = 3
    dim = 2 + div(side * (side + 1), 2)
    c = Float64[-1, 0]
...
function epipersumexp1(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    l = 5
    c = vcat(0.0, -ones(l))
...
function epipersumexp2(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    l = 5
    c = vcat(0.0, -ones(l))
    A = Float64[1 zeros(1, l)]
    b = Float64[1]
...
function envelope1(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    # dense methods
...
function envelope2(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    # dense methods
...
function envelope3(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
...
function envelope4(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
...
function linearopt1(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
    # dense methods
...
function linearopt2(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
...
function namedpoly1(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
...
function namedpoly2(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
...
function namedpoly3(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
...
function namedpoly4(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
...
function namedpoly5(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
...
function namedpoly6(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
...
function namedpoly7(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
...
function namedpoly8(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
...
function namedpoly9(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
...
function namedpoly10(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
...
function namedpoly11(verbose::Bool, system_solver::Type{<:SO.CombinedHSDSystemSolver}, linear_model::Type{<:MO.LinearModel})
