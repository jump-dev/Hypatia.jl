...
insts["various"] = [
    (3, 4, 5, true, 0.1, 0.1, 0.1, 0.2, 0.2), SOCExpPSDOptimizer),
    (3, 4, 5, true, 0.1, 0.1, 0.1, 0.2, 0.2),),
    (3, 4, 5, false, 0.1, 0.1, 0.1, 0.2, 0.2), SOCExpPSDOptimizer),
    (3, 4, 5, false, 0.1, 0.1, 0.1, 0.2, 0.2),),
    (6, 8, 10, true, 0.1, 0.1, 0.1, 0.2, 0.2), SOCExpPSDOptimizer),
    (6, 8, 10, true, 0.1, 0.1, 0.1, 0.2, 0.2),),
    (6, 8, 10, false, 0.1, 0.1, 0.1, 0.2, 0.2), SOCExpPSDOptimizer),
    (6, 8, 10, false, 0.1, 0.1, 0.1, 0.2, 0.2),),
    (12, 16, 20, true, 0.1, 0.1, 0.1, 0.2, 0.2), SOCExpPSDOptimizer),
    (12, 16, 20, true, 0.1, 0.1, 0.1, 0.2, 0.2),),
    (12, 16, 20, false, 0.1, 0.1, 0.1, 0.2, 0.2), SOCExpPSDOptimizer),
    (12, 16, 20, false, 0.1, 0.1, 0.1, 0.2, 0.2),),
    ]
