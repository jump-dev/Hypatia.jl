...
insts["various"] = [
    ((3, 2, 20, true, 0.1, 0.1, 0.1, 0.2, 0.2), SOCExpPSDOptimizer),
    ((3, 2, 20, true, 0.1, 0.1, 0.1, 0.2, 0.2),),
    ((3, 2, 20, false, 0.1, 0.1, 0.1, 0.2, 0.2), SOCExpPSDOptimizer),
    ((3, 2, 20, false, 0.1, 0.1, 0.1, 0.2, 0.2),),
    ((6, 4, 40, true, 0.1, 0.1, 0.1, 0.2, 0.2), SOCExpPSDOptimizer),
    ((6, 4, 40, true, 0.1, 0.1, 0.1, 0.2, 0.2),),
    ((6, 4, 40, false, 0.1, 0.1, 0.1, 0.2, 0.2), SOCExpPSDOptimizer),
    ((6, 4, 40, false, 0.1, 0.1, 0.1, 0.2, 0.2),),
    ((12, 8, 80, true, 0.1, 0.1, 0.1, 0.2, 0.2), SOCExpPSDOptimizer),
    ((12, 8, 80, true, 0.1, 0.1, 0.1, 0.2, 0.2),),
    ((12, 8, 80, false, 0.1, 0.1, 0.1, 0.2, 0.2), SOCExpPSDOptimizer),
