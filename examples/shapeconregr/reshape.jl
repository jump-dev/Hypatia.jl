...
for i in 1:6
    ...
    longres = longres[[:fold, :signal_ratio, :deg, :use_wsos, :tm, :tr_rmse, :ts_rmse, :ignore_mono, :refrmse]]
    categorical!(longres, [:signal_ratio])

    longres_tm = longres[longres.ignore_mono .== false, :]
    longres_tm = longres_tm[[:fold, :signal_ratio, :deg, :use_wsos, :tm, :refrmse]]
    ...
    longres_er = longres_er[[:fold, :signal_ratio, :deg, :tr_rmse, :ts_rmse, :ignore_mono, :refrmse]]
