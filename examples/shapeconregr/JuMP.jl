...
insts["fast"] = [
    ...
    ((:naics5811, 3, false, true, true, true, false), StandardConeOptimizer),
    ((:naics5811, 3, false, true, true, true, false),),
    ((:naics5811, 3, false, false, true, true, false),),
    ((:naics5811, 3, false, true, true, false, false), StandardConeOptimizer),
    ...
    ((2, 50, :func3, 5, 3, false, true, true, true, false), StandardConeOptimizer),
    ((2, 50, :func4, 5, 3, false, true, true, true, false),),
    ((2, 50, :func4, 5, 3, false, true, true, true, false), StandardConeOptimizer),
...
insts["slow"] = [
    ...
    ((4, 150, :func6, 0, 4, false, true, true, true, true), StandardConeOptimizer),
    ...
    ((3, 500, :func8, 0, 6, false, true, true, true, true), StandardConeOptimizer),
    ((3, 500, :func8, 0, 6, false, true, true, false, true), StandardConeOptimizer),
    ((3, 500, :func8, 0, 6, false, true, false, true, true), StandardConeOptimizer),
    ((5, 500, :func9, 9, 4, false, true, true, true, false),),
    ((5, 500, :func9, 9, 4, true, true, true, true, false),),
    ((5, 500, :func9, 9, 4, false, true, true, true, false), StandardConeOptimizer),
    ((5, 500, :func10, 4, 4, false, true, true, true, false),),
    ((5, 500, :func10, 4, 4, false, false, true, true, false),),
    ((5, 500, :func10, 4, 4, false, true, false, true, false), StandardConeOptimizer),
    ((5, 500, :func10, 4, 4, false, true, false, false, false), StandardConeOptimizer),
