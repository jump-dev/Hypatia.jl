...
insts["slow"] = [
    ((:naics5811, 3, false, true, false, true, false), :SOCExpPSD),
    ((:naics5811, 7, true, false, true, true, false),),
    ((:naics5811, 5, false, true, true, true, false), :SOCExpPSD),
    ...
    ((4, 150, :func6, 0, 4, false, true, true, true, true), :SOCExpPSD),
    ...
    ((3, 500, :func8, 0, 6, false, true, true, true, true), :SOCExpPSD),
    ((3, 500, :func8, 0, 6, false, true, true, false, true), :SOCExpPSD),
    ((3, 500, :func8, 0, 6, false, true, false, true, true), :SOCExpPSD),
    ((5, 500, :func9, 9, 4, false, true, true, true, false),),
    ((5, 500, :func9, 9, 4, true, true, true, true, false),),
    ((5, 500, :func9, 9, 4, false, true, true, true, false), :SOCExpPSD),
    ((5, 500, :func10, 4, 4, false, true, true, true, false),),
    ((5, 500, :func10, 4, 4, false, false, true, true, false),),
    ((5, 500, :func10, 4, 4, false, true, false, true, false), :SOCExpPSD),
    ((5, 500, :func10, 4, 4, false, true, false, false, false), :SOCExpPSD),
    ((5, 500, :func10, 4, 4, false, true, true, false, false), :SOCExpPSD),
    ((5, 500, :func10, 4, 4, false, true, true, true, false), :SOCExpPSD),
    ]
insts["various"] = [
