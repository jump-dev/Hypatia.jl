...
function run_JuMP_sosmat4_matrix_rand(; use_wsos::Bool=true, rseed::Int=1)
    n = 3
    m = 3
    d = 1
...
function run_JuMP_sosmat4_matrix_a(; use_wsos::Bool=true)
    @polyvar x[1:1]
...
function run_JuMP_sosmat4_poly_a(; use_wsos::Bool=true)
    @polyvar x[1:1]
    poly = x[1]^4 + 2x[1]^2
...
function run_JuMP_sosmat4_poly_b(; use_wsos::Bool=true)
    @polyvar x[1:2]
