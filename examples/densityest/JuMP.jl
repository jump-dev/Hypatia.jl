...
function densityestJuMP(
    ...
    if use_monomials
        ...
        JuMP.@constraints(model, begin
            ...
            [f(pts[i, :]) for i in 1:U] in HYP.WSOSPolyInterpCone{Float64, Float64}(U, [P0, PWts...]) # density nonnegative
        ...
        JuMP.@constraints(model, begin
            ...
            f in HYP.WSOSPolyInterpCone{Float64, Float64}(U, [P0, PWts...]) # density nonnegative
