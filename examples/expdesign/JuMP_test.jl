...
insts["various"] = [
    ...
    ((3, 5, 7, 2, false, true, false),),
    ((3, 5, 7, 2, false, true, false), ExpPSDOptimizer),
    ((3, 5, 7, 2, false, true, false), SOCExpPSDOptimizer),
    ((3, 5, 7, 2, false, false, true),),
    ((3, 5, 7, 2, false, false, true), ExpPSDOptimizer),
    ((3, 5, 7, 2, false, false, true), SOCExpPSDOptimizer),
    ((5, 15, 25, 5, true, false, false),),
    ((5, 15, 25, 5, true, false, false), SOCExpPSDOptimizer),
    ((5, 15, 25, 5, false, true, false),),
    ((5, 15, 25, 5, false, true, false), ExpPSDOptimizer),
    ((5, 15, 25, 5, false, true, false), SOCExpPSDOptimizer),
    ((5, 15, 25, 5, false, false, true),),
    ((5, 15, 25, 5, false, false, true), ExpPSDOptimizer),
    ((5, 15, 25, 5, false, false, true), SOCExpPSDOptimizer),
    ((100, 200, 200, 10, true, false, false),),
    ((100, 200, 200, 10, true, false, false), SOCExpPSDOptimizer),
    ((100, 200, 200, 10, false, true, false),),
    ((100, 200, 200, 10, false, true, false), ExpPSDOptimizer),
    ((100, 200, 200, 10, false, true, false), SOCExpPSDOptimizer),
    ((100, 200, 200, 10, false, false, true),),
    ((100, 200, 200, 10, false, false, true), ExpPSDOptimizer),
    ((100, 200, 200, 10, false, false, true), SOCExpPSDOptimizer),
    ]
